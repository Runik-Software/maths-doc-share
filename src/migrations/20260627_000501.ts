...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_archive_relation_to" AS ENUM('posts', 'reviews');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_archive_relation_to" AS ENUM('posts', 'reviews');
  ...
  CREATE TYPE "public"."enum_resource_types_icon" AS ENUM('fileText', 'bookOpen', 'clipboardCheck');
  ...
  CREATE TABLE "resources_at_a_glance" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"text" varchar
  ...
  CREATE TABLE "resources_learning_objectives" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"text" varchar
  ...
  CREATE TABLE "resources_populated_authors" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"name" varchar,
  ...
  CREATE TABLE "_resources_v_version_at_a_glance" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"text" varchar,
  ...
  CREATE TABLE "_resources_v_version_learning_objectives" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"text" varchar,
  ...
  CREATE TABLE "_resources_v_version_populated_authors" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_uuid" varchar,
  ...
  CREATE TABLE "_resources_v" (
  	...
  	"version_resource_type_id" integer,
  	"version_verified" boolean DEFAULT false,
  	"version_meta_title" varchar,
  	"version_meta_image_id" integer,
  	"version_meta_description" varchar,
  	"version_published_at" timestamp(3) with time zone,
  	"version_average_rating" numeric DEFAULT 0,
  ...
  CREATE TABLE "resource_types" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar NOT NULL,
  	"icon" "enum_resource_types_icon" DEFAULT 'fileText',
  	"order" numeric DEFAULT 0,
  	"generate_slug" boolean DEFAULT true,
  	"slug" varchar NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE "reviews" (
  	...
  	"populated_author_picture" varchar,
  	"populated_author_headline" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  ALTER TABLE "resources_at_a_glance" ADD CONSTRAINT "resources_at_a_glance_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."resources"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "resources_learning_objectives" ADD CONSTRAINT "resources_learning_objectives_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."resources"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "resources_populated_authors" ADD CONSTRAINT "resources_populated_authors_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."resources"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "resources" ADD CONSTRAINT "resources_resource_type_id_resource_types_id_fk" FOREIGN KEY ("resource_type_id") REFERENCES "public"."resource_types"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "resources_rels" ADD CONSTRAINT "resources_rels_media_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "resources_rels" ADD CONSTRAINT "resources_rels_grades_fk" FOREIGN KEY ("grades_id") REFERENCES "public"."grades"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "resources_rels" ADD CONSTRAINT "resources_rels_users_fk" FOREIGN KEY ("users_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_resources_v_version_at_a_glance" ADD CONSTRAINT "_resources_v_version_at_a_glance_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_resources_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_resources_v_version_learning_objectives" ADD CONSTRAINT "_resources_v_version_learning_objectives_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_resources_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_resources_v_version_populated_authors" ADD CONSTRAINT "_resources_v_version_populated_authors_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_resources_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_resources_v" ADD CONSTRAINT "_resources_v_version_subject_id_subjects_id_fk" FOREIGN KEY ("version_subject_id") REFERENCES "public"."subjects"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_resources_v" ADD CONSTRAINT "_resources_v_version_resource_type_id_resource_types_id_fk" FOREIGN KEY ("version_resource_type_id") REFERENCES "public"."resource_types"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_resources_v_rels" ADD CONSTRAINT "_resources_v_rels_media_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_resources_v_rels" ADD CONSTRAINT "_resources_v_rels_grades_fk" FOREIGN KEY ("grades_id") REFERENCES "public"."grades"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_resources_v_rels" ADD CONSTRAINT "_resources_v_rels_users_fk" FOREIGN KEY ("users_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "reviews" ADD CONSTRAINT "reviews_resource_id_resources_id_fk" FOREIGN KEY ("resource_id") REFERENCES "public"."resources"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "users_auth0_sub_idx" ON "users" USING btree ("auth0_sub");
  CREATE INDEX "users_updated_at_idx" ON "users" USING btree ("updated_at");
  CREATE INDEX "users_created_at_idx" ON "users" USING btree ("created_at");
  CREATE INDEX "resources_at_a_glance_order_idx" ON "resources_at_a_glance" USING btree ("_order");
  CREATE INDEX "resources_at_a_glance_parent_id_idx" ON "resources_at_a_glance" USING btree ("_parent_id");
  CREATE INDEX "resources_learning_objectives_order_idx" ON "resources_learning_objectives" USING btree ("_order");
  CREATE INDEX "resources_learning_objectives_parent_id_idx" ON "resources_learning_objectives" USING btree ("_parent_id");
  CREATE INDEX "resources_populated_authors_order_idx" ON "resources_populated_authors" USING btree ("_order");
  CREATE INDEX "resources_populated_authors_parent_id_idx" ON "resources_populated_authors" USING btree ("_parent_id");
  ...
  CREATE INDEX "resources_resource_type_idx" ON "resources" USING btree ("resource_type_id");
  ...
  CREATE INDEX "resources_rels_media_id_idx" ON "resources_rels" USING btree ("media_id");
  ...
  CREATE INDEX "resources_rels_grades_id_idx" ON "resources_rels" USING btree ("grades_id");
  CREATE INDEX "resources_rels_users_id_idx" ON "resources_rels" USING btree ("users_id");
  CREATE INDEX "_resources_v_version_at_a_glance_order_idx" ON "_resources_v_version_at_a_glance" USING btree ("_order");
  CREATE INDEX "_resources_v_version_at_a_glance_parent_id_idx" ON "_resources_v_version_at_a_glance" USING btree ("_parent_id");
  CREATE INDEX "_resources_v_version_learning_objectives_order_idx" ON "_resources_v_version_learning_objectives" USING btree ("_order");
  CREATE INDEX "_resources_v_version_learning_objectives_parent_id_idx" ON "_resources_v_version_learning_objectives" USING btree ("_parent_id");
  CREATE INDEX "_resources_v_version_populated_authors_order_idx" ON "_resources_v_version_populated_authors" USING btree ("_order");
  CREATE INDEX "_resources_v_version_populated_authors_parent_id_idx" ON "_resources_v_version_populated_authors" USING btree ("_parent_id");
  ...
  CREATE INDEX "_resources_v_version_version_subject_idx" ON "_resources_v" USING btree ("version_subject_id");
  CREATE INDEX "_resources_v_version_version_resource_type_idx" ON "_resources_v" USING btree ("version_resource_type_id");
  ...
  CREATE INDEX "_resources_v_rels_media_id_idx" ON "_resources_v_rels" USING btree ("media_id");
  ...
  CREATE INDEX "_resources_v_rels_grades_id_idx" ON "_resources_v_rels" USING btree ("grades_id");
  CREATE INDEX "_resources_v_rels_users_id_idx" ON "_resources_v_rels" USING btree ("users_id");
  ...
  CREATE UNIQUE INDEX "grades_slug_idx" ON "grades" USING btree ("slug");
  ...
  CREATE UNIQUE INDEX "resource_types_slug_idx" ON "resource_types" USING btree ("slug");
  ...
  CREATE INDEX "reviews_resource_idx" ON "reviews" USING btree ("resource_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "resources_at_a_glance" CASCADE;
  DROP TABLE "resources_learning_objectives" CASCADE;
  DROP TABLE "resources_populated_authors" CASCADE;
  DROP TABLE "resources" CASCADE;
  DROP TABLE "resources_rels" CASCADE;
  DROP TABLE "_resources_v_version_at_a_glance" CASCADE;
  DROP TABLE "_resources_v_version_learning_objectives" CASCADE;
  DROP TABLE "_resources_v_version_populated_authors" CASCADE;
  ...
  DROP TYPE "public"."enum_resource_types_icon";
